    ...
    <main class="unit size1of1 m-size1of1 mjp-below16 cf mjp-main" id="main">
        ...
        <div class="unit size1of1 m-size1of1 mjp-cards mjp-top32">
            <picture>
                ...
                <img class="mjp-cards__image" src="./images/finearts-fullpage-small.jpg" alt="TCU AddRan College of Liberal Arts">
            </picture>
        </div>
        ...
        <div class="unit size1of1 m-size1of1 mjp-cards mjp-top32">
            <picture>
                ...
                <img class="mjp-cards__image" src="./images/graphic-design-small.jpg" alt="TCU AddRan College of Liberal Arts">
            </picture>
        </div>
